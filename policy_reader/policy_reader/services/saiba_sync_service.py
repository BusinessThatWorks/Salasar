...
class SaibaSyncService:
    ...
    def _build_motor_policy_payload(self, policy_doc):
        ...
        return {
            ...
            "busBrokDate": self._format_date_for_saiba(policy_doc.policy_issuance_date),
            ...
            "prevPolicy": "Yes" if policy_doc.old_control_number else "No",
            ...
            "registrationDate": self._format_date_for_saiba(policy_doc.policy_start_date),
